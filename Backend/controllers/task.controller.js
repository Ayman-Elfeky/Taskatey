...
module.exports.createTask = async (req, res) => {
    ...
    const userID = req.user.id;
    const { name = title, description, status, dueDate, project, assignedTo, progress, isRecurring, recurrencePattern } = req.body;
    // const name = title;
    console.log("\n\n\n\n Assigned TTOOO: ", assignedTo, "\n\n\n\n")
    try {
