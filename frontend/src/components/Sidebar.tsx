    ...
    <>
      ...
      >
        ...
        <div className={cn(
          ...
          {/* <Button variant="ghost" size="icon" className="transform transition-all rotate-0 duration-300 hover:rotate-180">
            <Link to="/settings">
          ...
          <Button onClick={handleLogout} variant="ghost" size="icon" className={`w-full hover:bg-gray-200 dark:hover:bg-slate-500`}>
            <LogOut className="w-6 h-6" />
          {collapsed ? null : <span className="rotate-0">Logout</span>}
          </Button>
        </div>
      </aside>
