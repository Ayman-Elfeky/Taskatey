...
const MyTasks = () => {
  ...
  const calendarTasks: TaskGroups = {
    'To Do': Object.values(filteredTasks).flat().filter(task => {console.log(task); return task?.status === 'todo'}),
    'In Progress': Object.values(filteredTasks).flat().filter(task => {console.log(task); return task?.status === 'in progress'}),
    'Done': Object.values(filteredTasks).flat().filter(task => {console.log(task); return task?.status === 'done'})
  };
